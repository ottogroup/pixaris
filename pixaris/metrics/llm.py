...
class BaseLLMMetric(BaseMetric):
    ...
    def _PIL_image_to_vertex_image(self, image: Image) -> types.Part:
        """
        Converts a PIL image to a google-genai Part.

        :param image: The PIL image.
        :type image: PIL.Image.Image
        :return: The image part.
        :rtype: google.genai.types.Part
        """
    ...
    def _llm_prompt(
        ...
        :return: A list containing the JSON prompt and the images as google.genai.types.Part objects.
    ...
    def _successful_evaluation(
        self, prompt: list[types.Part], max_tries: int = 3
    ) -> dict:
        """
